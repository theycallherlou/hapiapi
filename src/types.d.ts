...
// --List of Changes for an Employee--
...
export const types = {
  IEECodesOfEmployeesWithChanges,
  IEmployeeChangesSensitive,
  IEmployeeChanges,
  IEmployeeId,
  IEmployeeNewHire,
  IEmployeeSensitive,
